    ...
    modifiers: {
      ...
      arrow: {
        ...
        fn: function(e, o) {
          ...
          var r = e.placement.split("-")[0],
            ...
            c = a ? "bottom" : "right",
            u = S(i)[l];
          d[c] - u < s[m] && (e.offsets.popper[m] -= s[m] - (d[c] - u)), d[m] +
            u >
            s[c] &&
            (e.offsets.popper[m] += d[m] + u - s[c]), (e.offsets.popper = g(
            e.offsets.popper
          ));
          var b = d[m] + d[l] / 2 - u / 2,
          ...
          return (v = ee(
            Q(s[l] - u, v),
            0
          )), (e.arrowElement = i), (e.offsets.arrow = (
            (n = {}),
            ae(n, m, $(v)),
            ae(n, h, ""),
            n
      ...
      inner: {
        ...
        fn: function(e) {
          ...
          return (i[p ? "left" : "top"] =
            r[o] - (s ? i[p ? "width" : "height"] : 0)), (e.placement = T(
            t
      ...
      computeStyle: {
        ...
        fn: function(e, t) {
          ...
          if (
            ...
            (m[b] = "translate3d(" + s + "px, " + d + "px, 0)"), (m[c] = 0), (m[
              g
      ...
      applyStyle: {
        ...
        enabled: !0,
        fn: function(e) {
          return V(e.instance.popper, e.styles), j(
            e.instance.popper,
            e.attributes
          ), e.arrowElement &&
