...
const icons = {};
icons.speafIcon = el('img', {
  src: (0,_wordpress_escape_html__WEBPACK_IMPORTED_MODULE_0__.escapeAttribute)(sp_easy_accordion_free.url + 'admin/GutenbergBlock/src/easy-accordion-icon.svg')
});
...
const DynamicShortcodeInput = _ref => {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(Fragment, null, el('div', {
    className: 'speaf-gutenberg-shortcode editor-styles-wrapper'
  }, el('select', {
    className: 'speaf-shortcode-selector',
  ...
  }, (0,_wordpress_escape_html__WEBPACK_IMPORTED_MODULE_1__.escapeHTML)(__('-- Select a shortcode --', 'easy-accordion-free'))), shortcodelist.map(shortcode => {
...
registerBlockType("sp-easy-accordion-free/shortcode", {
  title: (0,_wordpress_escape_html__WEBPACK_IMPORTED_MODULE_3__.escapeHTML)(__("Easy Accordion", "easy-accordion-free")),
  description: (0,_wordpress_escape_html__WEBPACK_IMPORTED_MODULE_3__.escapeHTML)(__("Use Easy Accordion to insert an accordion shortcode in your page.", "easy-accordion-free")),
  icon: _shortcode_blockIcon__WEBPACK_IMPORTED_MODULE_1__["default"].speafIcon,
  category: "common",
  supports: {
    html: true
  },
  edit: props => {
    ...
    if (attributes.preview) {
      return el('div', {
        className: 'speaf_shortcode_block_preview_image'
      }, el('img', {
        src: (0,_wordpress_escape_html__WEBPACK_IMPORTED_MODULE_3__.escapeAttribute)(sp_easy_accordion_free.url + "admin/GutenbergBlock/src/easy-acondion-preview.svg")
      }));
    }
    ...
    if (attributes.shortcodelist.length === 0) {
      return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(Fragment, null, el('div', {
        ...
        src: (0,_wordpress_escape_html__WEBPACK_IMPORTED_MODULE_3__.escapeAttribute)(sp_easy_accordion_free.url + 'admin/GutenbergBlock/src/easy-accordion-icon.svg')
      }), (0,_wordpress_escape_html__WEBPACK_IMPORTED_MODULE_3__.escapeHTML)(__("Easy Accordion", "easy-accordion-free"))), el('div', {
        className: 'components-placeholder__instructions'
      }, (0,_wordpress_escape_html__WEBPACK_IMPORTED_MODULE_3__.escapeHTML)(__("No shortcode found. ", "easy-accordion-free")), el('a', {
        href: (0,_wordpress_escape_html__WEBPACK_IMPORTED_MODULE_3__.escapeAttribute)(sp_easy_accordion_free.link)
      }, (0,_wordpress_escape_html__WEBPACK_IMPORTED_MODULE_3__.escapeHTML)(__("Create a shortcode now!", "easy-accordion-free"))))));
    }
    ...
    if (!attributes.shortcode || attributes.shortcode == 0) {
      return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4__.InspectorControls, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(PanelBody, {
        ...
        className: 'components-placeholder__instructions'
      }, (0,_wordpress_escape_html__WEBPACK_IMPORTED_MODULE_3__.escapeHTML)(__("Select a shortcode", "easy-accordion-free"))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_shortcode_dynamicShortcode__WEBPACK_IMPORTED_MODULE_2__["default"], {
        attributes: attributes,
        shortcodeUpdate: shortcodeUpdate
      })));
    }
    ...
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4__.InspectorControls, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(PanelBody, {
      ...
      block: "sp-easy-accordion-free/shortcode",
      attributes: attributes
    }));
  },
