; (function ($, window, document, undefined) {
  ...
  // Field: accordion
  //
  $.fn.eapro_field_accordion = function () {
    return this.each(function () {

      var $titles = $(this).find('.eapro-accordion-title');

      $titles.on('click', function () {

        var $title = $(this),
          $icon = $title.find('.eapro-accordion-icon'),
          $content = $title.next();
        ...
        if (!$content.data('opened')) {
          ...
          $content.eapro_reload_script();
          $content.data('opened', true);

        }

        $content.toggleClass('eapro-accordion-open');
  ...
  // Field: backup
  //
  $.fn.eapro_field_backup = function () {
    return this.each(function () {
      ...
      var base = this,
        $this = $(this),
        $body = $('body'),
        $import = $this.find('.eapro-import'),
        $reset = $this.find('.eapro-reset');
      ...
      base.notification = function (message_text) {
        ...
        if (wp.customize.notifications && wp.customize.OverlayNotification) {
          ...
          wp.customize.notifications.add(new wp.customize.OverlayNotification('eapro_field_backup_notification', {
            type: 'info',
      ...
      $reset.on('click', function (e) {
        ...
        if (SP_EAP.vars.is_confirm) {

          base.notification(window.eapro_vars.i18n.reset_notification);

          window.wp.ajax.post('eapro-reset', {
            ...
            .fail(function (response) {
              ...
              wp.customize.notifications.remove('eapro_field_backup_notification');
            });
      ...
      $import.on('click', function (e) {
        ...
        if (SP_EAP.vars.is_confirm) {
          ...
          base.notification(window.eapro_vars.i18n.import_notification);

          window.wp.ajax.post('eapro-import', {
            unique: $import.data('unique'),
            nonce: $import.data('nonce'),
            data: $this.find('.eapro-import-data').val()
          }).done(function (response) {
            window.location.reload(true);
          }).fail(function (response) {
            alert(response.error);
  ...
  // Field: background
  //
  $.fn.eapro_field_background = function () {
    return this.each(function () {
      $(this).find('.eapro--background-image').eapro_reload_script();
    });
  };
  ...
  // Field: fieldset
  //
  $.fn.eapro_field_fieldset = function () {
    return this.each(function () {
      $(this).find('.eapro-fieldset-content').eapro_reload_script();
    });
  };
  ...
  // Field: repeater
  //
  $.fn.eapro_field_repeater = function () {
    return this.each(function () {

      var $this = $(this),
        $fieldset = $this.children('.eapro-fieldset'),
        $repeater = $fieldset.length ? $fieldset : $this,
        $wrapper = $repeater.children('.eapro-repeater-wrapper'),
        $hidden = $repeater.children('.eapro-repeater-hidden'),
        $max = $repeater.children('.eapro-repeater-max'),
        $min = $repeater.children('.eapro-repeater-min'),
        field_id = $wrapper.data('field-id'),
        unique_id = $wrapper.data('unique-id'),
        max = parseInt($wrapper.data('max')),
        min = parseInt($wrapper.data('min'));
      ...
      $wrapper.children('.eapro-repeater-item').children('.eapro-repeater-content').eapro_reload_script();

      $wrapper.sortable({
        axis: 'y',
        handle: '.eapro-repeater-sort',
        helper: 'original',
        cursor: 'move',
        placeholder: 'widget-placeholder',
        update: function (event, ui) {

          SP_EAP.helper.name_nested_replace($wrapper.children('.eapro-repeater-item'), field_id);
          $wrapper.eapro_customizer_refresh();
          ui.item.eapro_reload_script_retry();

        }
      });

      $repeater.children('.eapro-repeater-add').on('click', function (e) {

        e.preventDefault();

        var count = $wrapper.children('.eapro-repeater-item').length;
        ...
        $cloned_item.removeClass('eapro-repeater-hidden');
        ...
        $wrapper.append($cloned_item);
        $cloned_item.children('.eapro-repeater-content').eapro_reload_script();
        $wrapper.eapro_customizer_refresh();
        $wrapper.eapro_customizer_listen({ closest: true });
      ...
      var event_clone = function (e) {
        ...
        var $this = $(this),
          ...
          $cloned_content = $parent.children('.eapro-repeater-content').eapro_clone(),
          $cloned_helper = $parent.children('.eapro-repeater-helper').eapro_clone(true),
          cloned_regex = new RegExp('(' + SP_EAP.helper.preg_quote(field_id) + ')\\[(\\d+)\\]', 'g');
        ...
        var $cloned = $('<div class="eapro-repeater-item" />');
        ...
        $cloned.children('.eapro-repeater-content').eapro_reload_script();
      ...
      $wrapper.children('.eapro-repeater-item').children('.eapro-repeater-helper').on('click', '.eapro-repeater-clone', event_clone);
      $repeater.children('.eapro-repeater-hidden').children('.eapro-repeater-helper').on('click', '.eapro-repeater-clone', event_clone);
      ...
      var event_remove = function (e) {
        ...
        $(this).closest('.eapro-repeater-item').remove();
      ...
      $wrapper.children('.eapro-repeater-item').children('.eapro-repeater-helper').on('click', '.eapro-repeater-remove', event_remove);
      $repeater.children('.eapro-repeater-hidden').children('.eapro-repeater-helper').on('click', '.eapro-repeater-remove', event_remove);
  ...
  // Field: slider
  //
  $.fn.eapro_field_slider = function () {
    return this.each(function () {

      var $this = $(this),
        $input = $this.find('input'),
        $slider = $this.find('.eapro-slider-ui'),
        data = $input.data(),
        value = $input.val() || 0;
  ...
  // Field: sortable
  //
  $.fn.eapro_field_sortable = function () {
    return this.each(function () {

      var $sortable = $(this).find('.eapro--sortable');
      ...
      $sortable.sortable({
        ...
        placeholder: 'widget-placeholder',
        update: function (event, ui) {
          $sortable.eapro_customizer_refresh();
        }
      });

      $sortable.find('.eapro--sortable-content').eapro_reload_script();
  ...
  // Field: sorter
  //
  $.fn.eapro_field_sorter = function () {
    return this.each(function () {

      var $this = $(this),
        $enabled = $this.find('.eapro-enabled'),
        $has_disabled = $this.find('.eapro-disabled'),
      ...
      $enabled.sortable({
        ...
        update: function (event, ui) {
          ...
          if (ui.item.parent().hasClass('eapro-enabled')) {
            $el.attr('name', $el.attr('name').replace('disabled', 'enabled'));
          } else {
            $el.attr('name', $el.attr('name').replace('enabled', 'disabled'));
          }

          $this.eapro_customizer_refresh();
  ...
  // Field: upload
  //
  $.fn.eapro_field_upload = function () {
    return this.each(function () {

      var $this = $(this),
        $input = $this.find('input'),
        $upload_button = $this.find('.eapro--button'),
        $remove_button = $this.find('.eapro--remove'),
  ...
  $.fn.eapro_reload_script = function (options) {
    ...
    return this.each(function () {
      ...
      if (!$this.data('inited')) {
        ...
        // Field plugins
        $this.children('.eapro-field-accordion').eapro_field_accordion();
        $this.children('.eapro-field-backup').eapro_field_backup();
        $this.children('.eapro-field-background').eapro_field_background();
        $this.children('.eapro-field-code_editor').eapro_field_code_editor();
        $this.children('.eapro-field-fieldset').eapro_field_fieldset();
        $this.children('.eapro-field-group').eapro_field_group();
        $this.children('.eapro-field-repeater').eapro_field_repeater();
        $this.children('.eapro-field-slider').eapro_field_slider();
        $this.children('.eapro-field-sortable').eapro_field_sortable();
        $this.children('.eapro-field-sorter').eapro_field_sorter();
        ...
        $this.children('.eapro-field-upload').eapro_field_upload();
        $this.children('.eapro-field-wp_editor').eapro_field_wp_editor();

        // Field colors
        $this.children('.eapro-field-border').find('.eapro-color').eapro_color();
        $this.children('.eapro-field-background').find('.eapro-color').eapro_color();
        ...
        $this.children('.eapro-field-link_color').find('.eapro-color').eapro_color();
        ...
        $this.children('.eapro-field-palette').find('.eapro-siblings').eapro_siblings();
